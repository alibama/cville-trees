...
dotradius = st.sidebar.slider("Tree dot radius",1,100,50,1) # this creates a slider widget called "tree dot radius"
...
view_state = pdk.ViewState(
    longitude=-78.507980, latitude=38.033554, zoom=11, min_zoom=5, max_zoom=15, pitch=20.5, bearing=27.36
)
